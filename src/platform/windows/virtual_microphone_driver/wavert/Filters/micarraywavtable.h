...
// Mic array range.
//
#define MICARRAY_RAW_CHANNELS                   1       // Mono client microphone audio.
#define MICARRAY_DEVICE_MAX_CHANNELS            1       // Capture endpoint is mono.
#define MICARRAY_BITS_PER_SAMPLE_PCM            16      // Signed 16-bit PCM.
