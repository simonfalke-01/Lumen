...
Abstract:
    ...
    WaveRT stream implementation adapted from Microsoft SimpleAudioSample.
...
)
{
    ...
    if (m_bCapture)
    {
        // Fill newly available capture bytes from the live Lumen PCM FIFO.
...
This function fills the WaveRT capture buffer from the Lumen PCM FIFO.
