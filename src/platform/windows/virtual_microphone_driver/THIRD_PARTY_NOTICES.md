...
The driver architecture and INF conventions were reviewed against Microsoft's
Windows Driver Samples, including SimpleAudioSample and SysVAD. Those samples
carry Microsoft copyright notices and are distributed under the Microsoft
Public License reproduced below.
