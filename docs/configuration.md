...
<table>
    ...
    <tr>
        ...
        <td>auto</td>
        <td>
            Prefer Virtual HID, with SendInput fallback only before the driver accepts a report and Virtual HID reclaim
            after a successful session reset.
        </td>
    </tr>
    <tr>
        <td>sendinput</td>
        <td>Always use SendInput without probing Virtual HID.</td>
    </tr>
</table>
...
<table>
    <tr>
        ...
        <td colspan="2">
            ...
            control for capping oversized encoded frames that would otherwise exceed Lumen's
